...
| #393 | Hide SQL blocks by default from user preference | Close and replace: main already has the preference, while this PR rejects supported defined SQL dialects in the component contract |
